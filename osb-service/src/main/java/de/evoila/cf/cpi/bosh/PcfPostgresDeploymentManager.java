...
/**
 * @author Marco Hennig, Johannes Hiemer, Patrick Weber.
 */
@Profile("pcf")
@Component
public class PcfPostgresDeploymentManager extends DeploymentManager {

    private CredentialStore credentialStore;

    public PcfPostgresDeploymentManager(BoshProperties properties,
	...
	String tdeKeyString = DatatypeConverter.printHexBinary(tdeBytes).toLowerCase();
        ...
        if (customParameters != null && !customParameters.isEmpty()){
            ...
            if (ssl!=null) {
                ...
                modifyCa(plan,(Map<String,Object>)ssl);
    ...
    private void modifyCa(Plan plan,Map<String,Object> ssl){
